...
//        String.format("%,.2f", Double.parseDouble(amtNeed)).toString().trim()
        ...
        if (Double.parseDouble(String.valueOf(activityList.get(position).getAmount())) < 1000) {
            holder.activityItemAmount.setText(String.format("%,.2f", activityList.get(position).getAmount()).toString().trim() + "/-");
        } else if (Double.parseDouble(String.valueOf(activityList.get(position).getAmount())) < 1000000 && Double.parseDouble(String.valueOf(activityList.get(position).getAmount())) >= 1000) {
            double tempAmount = Double.parseDouble(String.valueOf(activityList.get(position).getAmount()))/1000;
            holder.activityItemAmount.setText(String.format("%,.2f", tempAmount).toString().trim()+" K");
        } else if (Double.parseDouble(String.valueOf(activityList.get(position).getAmount())) >= 1000000 && Double.parseDouble(String.valueOf(activityList.get(position).getAmount())) < 1000000000){
            double tempAmount = Double.parseDouble(String.valueOf(activityList.get(position).getAmount()))/1000000;
            holder.activityItemAmount.setText(String.format("%,.2f", tempAmount).toString().trim()+" M");
        } else if (Double.parseDouble(String.valueOf(activityList.get(position).getAmount())) >= 1000000000){
            double tempAmount = Double.parseDouble(String.valueOf(activityList.get(position).getAmount()))/1000000000;
            holder.activityItemAmount.setText(String.format("%,.2f", tempAmount).toString().trim()+" B");
        }
